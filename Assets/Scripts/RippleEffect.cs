   ...
   // public float seaLevel = -1.0f;
    ...
    void UpdateShaderParameters()//更新shader参数
    {
       ...
       // material.SetFloat("_SeaLevel", seaLevel);
        ...
        material.SetVector("_Params1", new Vector4(c.aspect, 1, 1 / waveSpeed, radius));
    ...
    void Start()
    {
        ...
        gradTexture = new Texture2D(200, 1, TextureFormat.Alpha8, false);
